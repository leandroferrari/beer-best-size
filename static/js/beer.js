...
data += '      </div>';
data += '      <input type="tel" name="price" id="price" placeholder="0.00" class="form-control">';
data += '    </div>';
data += '  </div>';
data += '  <div class="form-group col-md-6">';
data += '    <div class="input-group">';
...
data += '      </div>';
data += '      <input type="tel" name="price_liter" id="price_liter" class="form-control price" disabled>';
data += '    </div>';
data += '  </div>';
data += '</div>';
data += '</div>';
