...
data += '      <option value="0.220">220 ml</option>';
data += '      <option value="0.250">250 ml</option>';
data += '      <option value="0.269">269 ml</option>';
data += '      <option value="0.275">275 ml</option>';
data += '      <option value="0.300">300 ml</option>';
data += '      <option value="0.310">310 ml</option>';
data += '      <option value="0.330">330 ml</option>';
data += '      <option value="0.350">350 ml</option>';
data += '      <option value="0.355">355 ml</option>';
data += '      <option value="0.410">410 ml</option>';
...
data += '      <option value="1">1000 ml</option>';
data += '      <option value="1.5">1500 ml</option>';
data += '      <option value="2">2000 ml</option>';
data += '      <option value="2.5">2500 ml</option>';
data += '      <option value="3">3000 ml</option>';
data += '      <option value="5">5000 ml</option>';
data += '    </select>';
data += '  </div>';
data += '</div>';
data += '<div class="form-row">';
